...
The functions from =mwim-beginning-functions= and =mwim-end-functions=
variables are called without arguments and they should return a new
point position.  For example, after:
